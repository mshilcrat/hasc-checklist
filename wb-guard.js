  ...
  sb.auth.getSession().then(function(res){
    ...
    return sb.from("profiles").select("role,residences").eq("id", uid).single().then(function(p){
      ...
      if(role === "admin"){
        ...
        if(isAC){ var acPages=["wb-hub-AC-mark2.html","wb-today-mark2.html","wb-insights-mark2.html","wb-documents-mark2.html","wb-checklists-mark2.html","wb-checkoff.html"]; var acOnAllowed=acPages.some(function(pg){ return path.indexOf(pg)!==-1; }); if(path.indexOf("wb-hub-mark2.html")!==-1 || !acOnAllowed){ location.replace("wb-hub-AC-mark2.html"); } } else { if(path.indexOf("wb-checkoff.html") === -1){ location.replace("wb-checkoff.html"); } }
      }
    });
